				...
				<?php print form::open(NULL, array('enctype' => 'multipart/form-data', 'id' => 'reportForm', 'name' => 'reportForm')); ?>
					...
					<div class="report-form">
						...
						<div class="f-col-1">
							...
							<div class="row">
								<h4><?php echo Kohana::lang('ui_main.reports_adm_level'); ?><span class="required">*</span> <small><a href="javascript:void();" id="getPcode" onclick="getPcode()" <?php echo (empty($form['adm_level'])) ? 'style="display:none;"' : '';?>>Get HLCIT Code</a></small><br />
							...
							<!-- Media Fields -->
							<div class="row link-row">
								<h4><?php echo Kohana::lang('ui_main.external_media_link');?></h4>
							</div>
							<div id="divMedia">
								<?php
								$this_div = "divMedia";
								$this_field = "incident_media";
								$this_startid = "media_id";
								$this_field_type = "text";
							...
							<?php Event::run('ushahidi_action.report_form_admin_after_media_link', $id); ?>
							
							<!-- Related incident Fields -->
							<div class="row link-row">
								<h4><?php echo Kohana::lang('ui_main.related_incident_link');?></h4>
							</div>
							...
							<?php Event::run('ushahidi_action.report_form_admin_after_related_incident_link', $id); ?>
