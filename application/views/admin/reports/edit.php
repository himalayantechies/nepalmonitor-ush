				...
				<?php print form::open(NULL, array('enctype' => 'multipart/form-data', 'id' => 'reportForm', 'name' => 'reportForm')); ?>
					...
					<div class="report-form">
						...
						<div class="f-col-1">
							...
							<div class="row">
								<h4><?php echo Kohana::lang('ui_main.reports_adm_level'); ?><span class="required">*</span> <small><a href="#" onclick="getPcode()">Get Location Name</a></small><br />
							...
							<div id="divNews">
								...
								$field_file = 'http://localhost/ushahidi-nepalmonitor/media/news_source.json';
