				...
				<?php print form::open(NULL, array('enctype' => 'multipart/form-data', 'id' => 'reportForm', 'name' => 'reportForm')); ?>
					...
					<div class="report-form">
						...
						<div class="f-col-1">
							...
							<div class="row">
								<h4><?php echo Kohana::lang('ui_main.reports_adm_level'); ?><span class="required">*</span> <small><a href="javascript:void();" id="getPcode" onclick="getPcode()" <?php (!empty($form['adm_level'])) ? 'style="display:none;"' : '';?>>Get HLCIT Code</a></small><br />
