...
class Themes_Core {
	...
	*/
	...
	private function _header_js()
	{
		...
		$core_js .= html::script($this->js_url."media/js/jquery-ui.min-1.8.13", TRUE);
		...
		if ($this->map_enabled)
		{
			...
			if ($this->main_page)
			{
				...
				$core_js .= html::script($this->js_url."media/js/jqplot.barRenderer.min"); // HT: for point label on graph
				$core_js .= html::script($this->js_url."media/js/jqplot.pointLabels.min"); // HT: for point label on graph
				$core_js .= html::script($this->js_url."media/js/jqplot.cursor.min"); // HT: for cursor label on graph
